...
const EMPLOYEE_GROUP_DISABLED_PERMS_BY_ID = {
    ...
    hrm_employees_view_salary_section: E_VIEW_EDIT,
    hrm_employees_view_personal_details: E_ONLY_VIEW,
    hrm_employees_view_documents: E_ONLY_VIEW,
    hrm_employees_view_basic: ['isCreate', 'isDelete', 'isDownload'],
    hrm_employees_view_work_employee: ['isCreate', 'isDelete', 'isDownload'],
    ...
    hrm_employees_view_current_address: ['isDelete'],
    hrm_employees_view_emergency: ['isDelete'],
