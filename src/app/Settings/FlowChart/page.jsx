        ...
        <div className="flex h-screen bg-[#F8FAFC]">
            ...
            <div className="flex-1 flex flex-col overflow-hidden">
                ...
                <main className="flex-1 overflow-y-auto bg-slate-50/50">
                    <div className="p-3 sm:p-5 lg:p-8 max-w-[1600px] mx-auto w-full">
                        {/* Header Section */}
                        <div className="flex flex-col md:flex-row md:items-center justify-between gap-3 sm:gap-4 lg:gap-6 mb-4 sm:mb-6 lg:mb-8">
                            <div className="flex items-center gap-3 sm:gap-4">
                                <div className="p-2.5 sm:p-3 lg:p-4 bg-white rounded-2xl sm:rounded-3xl shadow-sm border border-slate-100">
                                    <Network className="w-6 h-6 sm:w-7 sm:h-7 lg:w-8 lg:h-8 text-blue-600" />
                                </div>
                                <div>
                                    <h1 className="text-xl sm:text-2xl lg:text-3xl font-black text-slate-900 tracking-tight">Main ERP Flowchart</h1>
                                    <div className="flex items-center gap-2 mt-1">
                                        <div className="w-2 h-2 rounded-full bg-emerald-500 animate-pulse"></div>
                                        <p className="text-slate-500 text-[10px] sm:text-xs lg:text-sm font-bold uppercase tracking-widest text-blue-600">Universal Management Matrix (EST-001)</p>
                                    </div>
                                </div>
                            </div>
                        ...
                        {/* Tabs Navigation */}
                        <div className="flex items-center gap-2 sm:gap-3 lg:gap-4 mb-4 sm:mb-6 lg:mb-8 bg-white p-1 sm:p-1.5 rounded-xl sm:rounded-[1.5rem] shadow-sm border border-slate-100 w-full sm:w-fit overflow-x-auto">
                            <button
                                onClick={() => setActiveTab('responsibilities')}
                                className={`px-4 sm:px-6 lg:px-8 py-2 sm:py-2.5 lg:py-3 rounded-xl sm:rounded-2xl text-xs sm:text-sm font-black transition-all duration-300 whitespace-nowrap ${activeTab === 'responsibilities'
                            ...
                            <button
                                ...
                                className={`px-4 sm:px-6 lg:px-8 py-2 sm:py-2.5 lg:py-3 rounded-xl sm:rounded-2xl text-xs sm:text-sm font-black transition-all duration-300 whitespace-nowrap ${activeTab === 'flowchart'
                                    ? 'bg-blue-600 text-white shadow-lg shadow-blue-200 translate-y-[-2px]'
                                    : 'text-slate-500 hover:text-blue-600 hover:bg-slate-50'
                                    }`}
                            >
                            ...
                            {activeTab === 'responsibilities' ? (
                                <div className="bg-white rounded-2xl sm:rounded-[2.5rem] shadow-xl shadow-slate-200/50 border border-slate-100 p-4 sm:p-6 lg:p-10 min-h-[400px] sm:min-h-[600px]">
                                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-4 mb-6 sm:mb-8 lg:mb-10">
                                        <div>
                                            <h3 className="text-lg sm:text-xl lg:text-2xl font-black text-slate-900">Responsibility Matrix</h3>
                                            <p className="text-slate-400 text-[10px] sm:text-xs lg:text-sm font-bold uppercase tracking-wider mt-1 italic">Source of Truth for Fine, Loan, Reward & Advance Approvals</p>
                                        </div>
                                    ...
                                    <div className="overflow-x-auto rounded-xl sm:rounded-[2rem] border border-slate-50">
                                        <table className="w-full min-w-[640px] border-separate border-spacing-y-2 sm:border-spacing-y-4 px-1 sm:px-2 text-xs sm:text-sm">
                                            <thead>
                                                <tr className="text-left">
                                                    <th className="px-3 sm:px-6 lg:px-8 py-2 text-[9px] sm:text-[10px] font-black text-slate-400 uppercase tracking-[0.2em]">Position / Category</th>
                                                    <th className="px-3 sm:px-6 lg:px-8 py-2 text-[9px] sm:text-[10px] font-black text-slate-400 uppercase tracking-[0.2em]">Active Assignment</th>
                                                    <th className="px-3 sm:px-6 lg:px-8 py-2 text-[9px] sm:text-[10px] font-black text-slate-400 uppercase tracking-[0.2em]">Designation</th>
                                                    <th className="px-3 sm:px-6 lg:px-8 py-2 text-[9px] sm:text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] text-right pr-4 sm:pr-8 lg:pr-12">Action</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                {/* Default Categories */}
                                                                        ...
                                                                        {canIRespond ? (
                                                                            ...
                                                                            <div className="flex items-center justify-end gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                                                                                ...
                                                                                {CATEGORIES_POSITION_VIEW.includes(cat.id) && (
                                                                                    <button
                                                                                        type="button"
                                                                                        {...navHrefProps(`/Settings/FlowChart/position/${encodeURIComponent(cat.id)}`)}
                                ...
                                <div className="bg-white rounded-2xl sm:rounded-[2.5rem] shadow-xl shadow-slate-200/50 border border-slate-100 p-4 sm:p-6 lg:p-10 min-h-[480px] sm:min-h-[700px] flex flex-col items-center">
                                    <div className="w-full flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-4 mb-6 sm:mb-8 lg:mb-12 pb-4 sm:pb-6 border-b border-slate-50">
                                        <div>
                                            <h3 className="text-lg sm:text-xl lg:text-2xl font-black text-slate-900">Operational Hierarchy</h3>
                                            <p className="text-slate-400 text-[10px] sm:text-xs lg:text-sm font-bold uppercase tracking-wider mt-1">Mapping Approvals for Fine, Reward, Loan & Advance</p>
                                        </div>
                                        <button
                                            onClick={() => {
                                                fetchCompanyData(selectedCompanyId);
                                            ...
                                            className="bg-emerald-500 hover:bg-emerald-600 text-white px-4 sm:px-6 lg:px-8 py-2 sm:py-3 lg:py-4 rounded-xl sm:rounded-2xl text-xs sm:text-sm font-black transition-all shadow-xl shadow-emerald-100 flex items-center gap-2 sm:gap-3 transform hover:scale-105 whitespace-nowrap"
                                        >
                                    ...
                                    <div className="w-full h-full flex flex-col items-center gap-8 sm:gap-12 lg:gap-16 py-6 sm:py-8 lg:py-12">
                                        {/* Top Level: Management */}
                                        <div className="flex flex-col items-center gap-8 sm:gap-12 lg:gap-16 w-full">
                                            <div className="flex flex-wrap justify-center gap-4 sm:gap-6 lg:gap-10">
                                                {responsibilities.filter(r => r.category === 'management').map((r, i) => (
                                                    <div key={i} className="flex flex-col items-center gap-2 sm:gap-3 lg:gap-4 group">
                                                        <div className="w-20 h-20 sm:w-24 sm:h-24 lg:w-28 lg:h-28 rounded-[1.5rem] sm:rounded-[2rem] lg:rounded-[2.5rem] bg-gradient-to-br from-blue-600 to-indigo-700 p-1.5 shadow-2xl shadow-blue-200 group-hover:scale-110 group-hover:rotate-3 transition-all duration-500">
                                                            <div className="w-full h-full rounded-[1.3rem] sm:rounded-[1.7rem] lg:rounded-[2.2rem] bg-white flex items-center justify-center text-blue-600 font-black text-xl sm:text-2xl lg:text-3xl">
                                                                {r.employeeName?.[0]}
                                                            </div>
                                                        </div>
                                                        <div className="text-center">
                                                            <p className="text-sm sm:text-base lg:text-lg font-black text-slate-800">{r.employeeName}</p>
                                                            <p className="text-[9px] sm:text-[10px] font-black text-blue-600 uppercase tracking-[0.2em] mt-1 bg-blue-50 px-2 sm:px-3 py-1 rounded-full border border-blue-100 inline-block">Chief Executive</p>
                                                        </div>
                                                    </div>
                                                ))}
                                            </div>
