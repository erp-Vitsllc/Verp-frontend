            ...
            <div className="flex-1 flex flex-col min-w-0 w-full max-w-full">
                ...
                <div className="p-3 sm:p-5 lg:p-8 w-full max-w-full overflow-x-hidden">
                    ...
                    <div className="mb-4 sm:mb-6">
                        <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-800 mb-1 sm:mb-2">Create Group</h1>
                        <p className="text-sm sm:text-base text-gray-600">Create a new user group, assign users and set permissions.</p>
                    </div>
