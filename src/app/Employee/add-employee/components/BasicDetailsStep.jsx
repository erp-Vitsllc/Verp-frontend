            ...
            <div className="grid grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <DatePicker
                        ...
                        onBlur={() => validateBasicDetailField('dateOfJoining', basicDetails.dateOfJoining)}
                        dateFormat="yyyy-MM-dd"
                        className={`w-full px-5 py-2 border rounded-xl focus:outline-none focus:ring-2 ${fieldErrors?.dateOfJoining ? 'border-red-500 bg-red-50 focus:ring-red-500' : 'border-blue-200 bg-blue-50 text-blue-900 focus:ring-blue-500'}`}
                ...
                <div>
                    ...
                    <PhoneInput
                        ...
                        inputStyle={{
                            ...
                            height: '42px',
                            borderRadius: '0.5rem',
                            borderColor: fieldErrors?.contactNumber ? '#ef4444' : '#d1d5db'
                        }}
                        buttonStyle={{
