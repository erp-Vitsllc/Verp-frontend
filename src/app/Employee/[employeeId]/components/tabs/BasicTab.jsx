        ...
        <div>
            ...
            <div className="space-y-6">
                ...
                {(() => {
                    ...
                    const isResident = hasEmploymentVisa || hasSpouseVisa;
                    ...
                    if (isResident && !employee.medicalInsuranceDetails?.provider && (isAdmin() || hasPermission('hrm_employees_view_medical_insurance', 'isView'))) {
                        documentButtons.push(
                            <button
                    ...
                    if (isResident && !employee.drivingLicenceDetails?.number && (isAdmin() || hasPermission('hrm_employees_view_driving_license', 'isView'))) {
                        documentButtons.push(
                            <button
                                key="driving-license"
                                onClick={(e) => {
