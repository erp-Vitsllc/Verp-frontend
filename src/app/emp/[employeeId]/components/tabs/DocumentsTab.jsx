                                            ...
                                            <tr key={doc.id} className="bg-white hover:bg-gray-50 transition-colors shadow-sm ring-1 ring-gray-100 rounded-lg group">
                                                ...
                                                <td className="py-3 px-4 text-sm text-gray-500">
                                                    <button
                                                        ...
                                                        className="text-blue-600 hover:text-blue-800 underline truncate max-w-[200px] block font-medium"
                                                        title={doc.document?.name || 'View Document'}
                                                    >
                                                        {doc.document?.name || 'View Document'}
                                                    </button>
                                                </td>
