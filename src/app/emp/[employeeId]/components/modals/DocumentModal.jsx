                    ...
                    {!isLabour && (
                        <div className="flex flex-col gap-2 border border-gray-100 rounded-xl px-4 py-2 bg-white">
                            ...
                            <textarea
                                ...
                                className={`w-full min-h-[90px] px-3 py-2 rounded-xl border ${documentErrors.description ? 'border-red-500' : 'border-[#E5E7EB]'} bg-[#F7F9FC] text-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-40`}
                                placeholder="Enter document description"
                                disabled={savingDocument}
                            />
                            {documentErrors.description && (
                                <p className="text-xs text-red-500">{documentErrors.description}</p>
                            )}
                        </div>
                    )}
