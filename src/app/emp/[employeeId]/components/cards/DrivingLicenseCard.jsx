            ...
            return (
                <div className="rounded-2xl shadow-sm border break-inside-avoid mb-6 bg-white border-gray-100">
                    <div className="flex items-center px-3 sm:px-6 py-2.5 sm:py-4 border-b border-gray-100">
                        <h3 className="text-base sm:text-xl font-semibold text-gray-800">Driving Licences</h3>
                    </div>
                    <p className="px-3 sm:px-6 py-2.5 sm:py-4 text-sm text-gray-500">No driving licence on file.</p>
                </div>
            );
        }
        return (
