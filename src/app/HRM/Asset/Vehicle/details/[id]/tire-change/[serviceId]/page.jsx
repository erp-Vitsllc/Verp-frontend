...
import VehicleTireChangeDetailHeaderCards from '@/app/HRM/Asset/Vehicle/components/VehicleTireChangeDetailHeaderCards';
import VehicleTireChangeDetailForm from '@/app/HRM/Asset/Vehicle/components/VehicleTireChangeDetailForm';
...
import {
    resolveTireChangeWorkflowStage,
    showTireChangeGarageCard,
    showTireChangeQuoteCard,
    showTireChangeReturnCard,
    TIRE_CHANGE_WORKFLOW_STAGES,
} from '@/app/HRM/Asset/Vehicle/utils/vehicleTireChangeWorkflow';
...
function VehicleTireChangeDetailPageContent() {
    ...
    const service = useMemo(() => {
        ...
        return (
            services.find((row) => {
                ...
                return vehicleServiceTypeKey(row) === 'Tire Change';
            }) || null
        );
    ...
    const tireWorkflowStage = useMemo(
                    ...
                    <div className="flex-1 flex flex-col items-stretch justify-start py-8 w-full px-6 md:px-8">
                        ...
                        <div className="flex flex-1 items-center justify-center">
                            <div className="flex flex-col items-center gap-3 text-slate-500">
                                ...
                                <span className="text-sm font-medium">Loading tire change details...</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="flex-1 flex flex-col">
                    ...
                    <div className="flex-1 flex flex-col items-stretch justify-start py-8 w-full px-6 md:px-8">
                        ...
                        <div className="bg-white rounded-lg p-12 text-center shadow-sm border border-gray-100">
                            ...
                            <h2 className="text-2xl font-bold text-gray-800 mb-2">Tire change request not found</h2>
        ...
        <div className="flex min-h-screen w-full bg-[#F2F6F9]">
            ...
            <div className="flex-1 flex flex-col min-w-0">
                ...
                <div className="flex-1 flex flex-col items-stretch justify-start py-8 relative overflow-y-auto w-full px-6 md:px-8 print:py-0 animate-in fade-in duration-300">
                    ...
                    <VehicleTireChangeDetailHeaderCards
                        vehicle={asset}
                        service={service}
                    ...
                    <div className={`${tireChangePageLayout.rowClassName} ${PAGE_SECTION_ANIMATION} delay-150`}>
                        <div className={tireChangePageLayout.mainColumnClassName}>
                            <div className="flex flex-col gap-5 w-full">
                                <VehicleTireChangeDetailForm
                                    asset={asset}
                                    service={service}
                                    vehicleId={vehicleId}
                                    serviceId={serviceId}
                        ...
                        <div className={`${tireChangePageLayout.sideColumnClassName} min-h-0`}>
                            <VehicleTireChangePreviousHistoryPanel
                                asset={asset}
                                service={service}
                                className="shrink-0"
                            />
                            <VehicleTireChangeDriverHistoryPanel
                                asset={asset}
                                service={service}
                                className="shrink-0"
                            />
...
export default function VehicleTireChangeDetailPage() {
    return (
        <PermissionGuard moduleId="hrm_asset_vehicle" redirectTo="/dashboard">
            ...
            >
                <VehicleTireChangeDetailPageContent />
            </Suspense>
        </PermissionGuard>
    );
}
