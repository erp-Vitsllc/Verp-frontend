...
import { buildMechanicalWorkPreviousHistoryEntries } from '../utils/vehicleMechanicalWorkPreviousHistory';
...
export default function VehicleMechanicalWorkPreviousHistoryPanel({ asset, service, className = '' }) {
    const entries = useMemo(
        () => buildMechanicalWorkPreviousHistoryEntries(asset, service?._id, { limit: 5 }),
        [asset, service?._id],
    );
    ...
    return (
        ...
        >
            ...
            >
                ...
                <div>
                    <h4 className="text-xl font-bold text-gray-800">Previous Mechanical Work History</h4>
                    <p className="mt-1 text-sm text-gray-500">Last 5 mechanical work services for this vehicle</p>
                </div>
            </div>
            ...
            {!entries.length ? (
                <div className="flex flex-1 items-center justify-center py-10">
                    <p className="text-center text-base text-gray-500 px-4">
                        No previous mechanical work records on file yet.
                    </p>
                </div>
            ) : (
