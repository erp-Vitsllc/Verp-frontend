...
import {
    canApproveMechanicalWorkGarageAccounts,
...
import {
    ...
    MECHANICAL_WORK_GARAGE_VENDOR_OPTIONS,
...
function buildGarageOptions(asset, service, currentName) {
    const set = new Set(MECHANICAL_WORK_GARAGE_VENDOR_OPTIONS);
    const add = (value) => {
...
export default function VehicleMechanicalWorkGarageCard({
    ...
    const canApproveAccounts = canApproveMechanicalWorkGarageAccounts(stage, canActAccounts);
