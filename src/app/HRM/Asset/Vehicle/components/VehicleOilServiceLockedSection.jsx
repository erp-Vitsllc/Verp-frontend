...
/**
 * Always-visible workflow card shell: when locked, fields stay visible but disabled,
 * with a lock overlay. Click shows why the step is not available yet.
 */
export default function VehicleOilServiceLockedSection({
    locked = false,
