...
export default function VehicleBodyWorkDetailForm({
    ...
    const [formData, setFormData] = useState(() => buildBodyWorkDetailFormState(service, asset));
    ...
    useEffect(() => {
        setFormData(buildBodyWorkDetailFormState(service, asset));
    ...
    return (
        <>
            <div className={`flex w-full ${className}`.trim()}>
                <FineFormCard
                    title="Body Work Assignment Details"
                    subtitle={
                        assignmentPending
                ...
                >
                    ...
                    <div className="mt-4 border-t border-gray-100 pt-4">
                        <span className="text-[10px] font-semibold uppercase tracking-wide text-gray-400">
                            Body Work Description (optional)
                        </span>
                        <textarea
