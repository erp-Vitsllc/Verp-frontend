...
import { buildTireChangePreviousHistoryEntries } from '../utils/vehicleTireChangePreviousHistory';
...
export default function VehicleTireChangePreviousHistoryPanel({ asset, service, className = '' }) {
    const entries = useMemo(
        () => buildTireChangePreviousHistoryEntries(asset, service?._id, { limit: 5 }),
        [asset, service?._id],
    );
    ...
    return (
        ...
        >
            ...
            >
                ...
                <div>
                    <h4 className="text-xl font-bold text-gray-800">Previous Tire Change History</h4>
                    <p className="mt-1 text-sm text-gray-500">Last 5 tire change services for this vehicle</p>
                </div>
            </div>
            ...
            {!entries.length ? (
                <div className="flex flex-1 items-center justify-center py-10">
                    <p className="text-center text-base text-gray-500 px-4">
                        No previous tire change records on file yet.
                    </p>
                </div>
            ) : (
