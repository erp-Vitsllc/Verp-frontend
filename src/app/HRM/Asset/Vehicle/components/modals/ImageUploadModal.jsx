        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-md animate-in fade-in duration-300">
            <div className="bg-white rounded-[32px] shadow-2xl w-full max-w-2xl overflow-hidden border border-white/20 animate-in zoom-in-95 duration-300">
                ...
                <div className="px-8 py-6 border-b border-slate-100 flex items-center justify-between bg-slate-50/50">
                    <div>
                        <h2 className="text-xl font-black text-slate-800 uppercase tracking-widest">Adjust Vehicle Photo</h2>
                        <p className="text-[10px] font-bold text-slate-400 uppercase tracking-wider mt-1">Crop and scale the image for the profile</p>
                    </div>
                    <button
                        onClick={onClose}
                        disabled={uploading}
