...
import { canEditBodyWorkQuoteCard, canEditBodyWorkQuoteEmployeeRows } from '../utils/vehicleBodyWorkWorkflow';
import {
    SHOP_SERVICE_CARD,
...
import { applyEmployeePayTargetToRows } from '../utils/vehicleBodyWorkDetailForm';
import { quoteKeyToLabel } from '../utils/vehicleBodyWorkQuoteDrag';
import {
...
export default function VehicleBodyWorkQuoteApprovalCard({
    asset,
    service,
    vehicleId,
    serviceId,
    ...
    const canEdit = useMemo(
        () =>
            canEditBodyWorkQuoteCard(assignmentPending, stage, {
                canActHr,
    ...
    const canEditEmployeeRows = useMemo(
        () =>
            canEditBodyWorkQuoteEmployeeRows(assignmentPending, stage, {
                canActHr,
                canManageBodyWork,
                canRespondToWorkflow,
            }),
        [assignmentPending, stage, canActHr, canManageBodyWork, canRespondToWorkflow],
    );
    ...
    const handleSaveEmployeeRows = async () => {
        ...
        try {
            const { data } = await axiosInstance.put(
                `/AssetItem/${vehicleId}/service/${serviceId}/body-work/quote-employees`,
                {
