import { buildAccidentRepairOilStyleWorkflowEvents } from './vehicleShopServiceDetailWorkflow';
...
export function buildAccidentRepairDetailWorkflowEvents(asset, service, flowchartRows = []) {
    return buildAccidentRepairOilStyleWorkflowEvents(asset, service, flowchartRows);
}
