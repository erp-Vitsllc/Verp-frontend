...
export const TIRE_CHANGE_DETAIL_GRID_LAYOUT = OIL_SERVICE_DETAIL_GRID_LAYOUT;
export const TIRE_CHANGE_DETAIL_GRID_ACCENTS = OIL_SERVICE_DETAIL_GRID_ACCENTS;
...
export function tireAccent(index) {
    return TIRE_CHANGE_DETAIL_GRID_ACCENTS[index % TIRE_CHANGE_DETAIL_GRID_ACCENTS.length];
}
