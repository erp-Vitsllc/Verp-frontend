...
export function createMechanicalWorkOtherDocRow() {
...
export function buildMechanicalWorkReturnFormState(service, asset) {
...
export function validateMechanicalWorkReturnForm(formData) {
    const errors = {};
...
export function isMechanicalWorkReturnFormComplete(formData) {
    return Object.keys(validateMechanicalWorkReturnForm(formData)).length === 0;
}
...
export function buildMechanicalWorkReturnUpdateBody(formData) {
...
export function buildMechanicalWorkReturnGoLivePayload(formData) {
    const completionReport = buildUploadPayload(
        formData.garageReportName,
        formData.garageReportBase64,
        formData.garageReportMime,
