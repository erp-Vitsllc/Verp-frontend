...
export const MECHANICAL_WORK_DETAIL_GRID_LAYOUT = OIL_SERVICE_DETAIL_GRID_LAYOUT;
export const MECHANICAL_WORK_DETAIL_GRID_ACCENTS = OIL_SERVICE_DETAIL_GRID_ACCENTS;
...
export function tireAccent(index) {
    return MECHANICAL_WORK_DETAIL_GRID_ACCENTS[index % MECHANICAL_WORK_DETAIL_GRID_ACCENTS.length];
}
