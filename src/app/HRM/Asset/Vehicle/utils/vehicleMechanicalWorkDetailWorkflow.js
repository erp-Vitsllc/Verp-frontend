...
export const MECHANICAL_WORK_WORKFLOW_STEPS = [
...
export function buildMechanicalWorkDetailWorkflowEvents(asset, service, flowchartRows = []) {
    ...
    const events = MECHANICAL_WORK_WORKFLOW_STEPS.map((step) => {
