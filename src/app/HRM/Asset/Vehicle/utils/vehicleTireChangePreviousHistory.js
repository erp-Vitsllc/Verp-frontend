...
function isCompletedTireChangeServiceRecord(service, asset) {
    return isCompletedShopServiceHistoryRecord(service, asset);
}

export function buildTireChangePreviousHistoryDetailHref(vehicleId, serviceId) {
    return buildShopServiceHistoryDetailHref(vehicleId, serviceId, 'Tire Change');
}

export function buildTireChangePreviousHistoryEntries(asset, currentServiceId, { limit = 5 } = {}) {
    if (!asset) return [];
    ...
    return services
        ...
        .filter((s) => isCompletedTireChangeServiceRecord(s, asset))
        ...
        .map((service) => {
            ...
            return {
                ...
                detailHref: buildTireChangePreviousHistoryDetailHref(asset._id, serviceId),
            };
        });
}
