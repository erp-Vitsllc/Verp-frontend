...
export const BODY_WORK_DETAIL_GRID_LAYOUT = OIL_SERVICE_DETAIL_GRID_LAYOUT;
export const BODY_WORK_DETAIL_GRID_ACCENTS = OIL_SERVICE_DETAIL_GRID_ACCENTS;
...
export function tireAccent(index) {
    return BODY_WORK_DETAIL_GRID_ACCENTS[index % BODY_WORK_DETAIL_GRID_ACCENTS.length];
}
