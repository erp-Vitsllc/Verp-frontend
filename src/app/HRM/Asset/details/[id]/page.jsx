    ...
    const { toolsHeaderPrimaryButtons, toolsHeaderOtherButtons } = useMemo(() => {
        ...
        const actions = [
            ...
            },
            {
                ...
                displayLabel: 'Asset (loss/damage)',
                onClick: () => {
            ...
            },
            {
                tier: 'primary',
                label: 'End of life',
                displayLabel: 'asset(end of life)',
                onClick: () => {
    ...
    return (
        <div className="flex h-screen w-full max-w-full overflow-hidden" style={{ backgroundColor: '#F2F6F9' }}>
            ...
            <div className="flex-1 flex flex-col min-w-0 h-full overflow-hidden relative">
                ...
                {/* Return Asset Modal — same layout as End of Services + mandatory description */}
                <ReturnAssetModal
                    isOpen={showReturnModal}
                    onClose={() => setShowReturnModal(false)}
                    asset={asset}
                    onUpdate={fetchAssetDetails}
                    canUseBulkReturnUi={canUseBulkReturnUi}
                    isAssigneeSelf={canUseBulkReturnUi}
                    isAssetController={effectiveIsAssetController || isAssetController}
                />
