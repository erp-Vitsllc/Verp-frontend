...
function CompanyProfilePageContent() {
    ...
    }, [filteredCompanyAssets, selectedCompanyAssetIds]);
                                ...
                                <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-8 min-h-[400px]">
                                    ...
                                    <div className="mb-4 flex flex-wrap items-center justify-end gap-2">
                                        ...
                                        <button
                                            ...
                                            disabled={selectedCompanyAssetIds.length === 0 || companyBulkSubmitting || selectedCompanyAssetsBlockTransfer}
                                            ...
                                            title={selectedCompanyAssetsBlockTransfer ? ZERO_ASSET_VALUE_TRANSFER_MESSAGE : 'Transfer asset'}
                                        >
